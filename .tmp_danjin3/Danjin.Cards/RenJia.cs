...
public class RenJia : DanjinCard
{
	...
	protected override IEnumerable<DynamicVar> CanonicalVars => new _003C_003Ez__ReadOnlyArray<DynamicVar>((DynamicVar[])(object)new DynamicVar[3]
	{
		...
		new DynamicVar("RenJiaStacks", 2m)
	});
	...
	protected override async Task OnPlay(PlayerChoiceContext choiceContext, CardPlay cardPlay)
	{
		...
		if (gongShi >= 1 && cardPlay.Target != null && cardPlay.Target.IsAlive)
		{
		...
		if (shouShi >= 1)
		{
			await PowerCmd.Apply<RenJiaPower>(choiceContext, ((CardModel)this).Owner.Creature, (decimal)(int)((CardModel)this).DynamicVars["RenJiaStacks"].BaseValue, ((CardModel)this).Owner.Creature, (CardModel)(object)this, false);
		}
	}
