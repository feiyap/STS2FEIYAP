...
public class JinMieI : DanjinCard
{
	...
	protected override IEnumerable<IHoverTip> AdditionalHoverTips
	{
		get
		{
			...
			yield return HoverTipFactory.FromCard<JinMieIi>(((CardModel)this).IsUpgraded);
	...
	protected override async Task OnPlay(PlayerChoiceContext choiceContext, CardPlay cardPlay)
	{
		...
		JinMieIi jinMieIi = ((CardModel)this).CombatState.CreateCard<JinMieIi>(((CardModel)this).Owner);
		if (((CardModel)this).IsUpgraded)
		{
			((CardModel)jinMieIi).UpgradeInternal();
			((CardModel)jinMieIi).FinalizeUpgradeInternal();
		}
		LianDuanPatch.RecentlyGenerated.Add((CardModel)(object)jinMieIi);
		CardCmd.PreviewCardPileAdd(await CardPileCmd.AddGeneratedCardToCombat((CardModel)(object)jinMieIi, (PileType)2, ((CardModel)this).Owner, (CardPilePosition)1), 1.2f, (CardPreviewStyle)1);
	}
