...
public sealed class FeiYu : DanjinRelic
{
	private const int OpeningAttackStance = 3;
	...
	public override async Task BeforeCombatStart()
	{
		...
		DanjinLog.Verbose($">>>[DanjinMod] 绯玉：战斗开始 → 开局获得 {3} 层攻势");
		await StanceCmd.GainAttackStance((PlayerChoiceContext)new BlockingPlayerChoiceContext(), ((RelicModel)this).Owner, 3);
	}
