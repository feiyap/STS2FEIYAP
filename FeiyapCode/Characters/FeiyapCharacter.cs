...
[RegisterCharacter]
public sealed class FeiyapCharacter : ModCharacterTemplate<FeiyapCardPool, FeiyapRelicPool, FeiyapPotionPool>
{
    ...
    private const string CharacterScenePath = $"{SceneRoot}/Feiyap_character.tscn";
    ...
    public override CharacterAssetProfile AssetProfile => new(
        ...
        Ui: new CharacterUiAssetSet(
            ...
            // 人物选择图标。
            CharacterSelectIconPath: $"{ImageRoot}/Feiyap_character_select.png",
            // 人物选择图标-锁定状态。
