...
public sealed class FeiyapCardPool : TypeListCardPoolModel
{
    ...
    public override string Title => "Feiyap";
    ...
    public override Color DeckEntryCardColor => FeiyapCharacter.ThemeColor;
